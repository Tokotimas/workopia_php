<?= loadPartial(name: 'head') ?>
<?= loadPartial(name: 'navbar') ?>
<?= loadPartial(name: 'top-banner') ?>

<section class="container mx-auto p-4 mt-4">
    <div class="rounded-lg shadow-md bg-white p-3">
        <?= loadPartial(name: 'message') ?>
        <div class="flex justify-between items-center">
            <a class="block p-4 text-blue-700" href="/listings">
                <i class="fa fa-arrow-alt-circle-left"></i>
                Back To Listings
            </a>
            <?php if (Framework\Authorization::isOwner(resourceId: $listing->user_id)): ?>
        ...
        <div class="p-4">
            ...
            <ul class="my-4 bg-gray-100 p-4">
                <li class="mb-2"><strong>Salary:</strong> <?= formatSalary(salary: $listing->salary) ?></li>
                <li class="mb-2">
...
<?= loadPartial(name: 'bottom-banner') ?>
