<?php loadPartial(name:'head'); ?>
<?php loadPartial(name:'navbar'); ?>
<?php loadPartial(name:'showcase-search'); ?>
<?php loadPartial(name:'top-banner'); ?>
    <!-- Job Listings -->
    <section>
...
<?php loadPartial(name: 'bottom-banner'); ?>
<?php loadPartial(name: 'footer'); ?>